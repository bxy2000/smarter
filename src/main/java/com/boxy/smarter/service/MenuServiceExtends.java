...
@Service
@Transactional
public class MenuServiceExtends {

    private final Logger log = LoggerFactory.getLogger(MenuServiceExtends.class);

    private final MenuRepository menuRepository;

    public MenuServiceExtends(MenuRepository menuRepository) {
