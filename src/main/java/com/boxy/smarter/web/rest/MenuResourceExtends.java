...
import com.boxy.smarter.service.MenuServiceExtends;
...
public class MenuResourceExtends {

    private final Logger log = LoggerFactory.getLogger(MenuResourceExtends.class);
    ...
    private final MenuServiceExtends menuServiceExtends;

    public MenuResourceExtends(MenuServiceExtends menuServiceExtends) {
        this.menuServiceExtends = menuServiceExtends;
    }
    ...
    public ResponseEntity<Menu> createMenu(@Valid @RequestBody Menu menu) throws URISyntaxException {
        ...
        Menu result = menuServiceExtends.save(menu);
    ...
    public List<Menu> getAllMenus() {
        ...
        return menuServiceExtends.findAll();
    }
    ...
    public ResponseEntity<Menu> getMenu(@PathVariable Long id) {
        ...
        Optional<Menu> menu = menuServiceExtends.findOne(id);
